...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/xkatld/lxdapi-web-server/main-stable/Shell/lxdapi_cloud_install.sh)
```

Gitee：

```bash
RELEASE_SOURCE=gitee bash <(curl -Ls https://gitee.com/xkatld/lxdapi-web-server/raw/main-stable/Shell/lxdapi_cloud_install.sh)
```

指定 Release 版本：

```bash
LXDAPI_TAG=v1.0.0 bash <(curl -Ls https://raw.githubusercontent.com/xkatld/lxdapi-web-server/main-stable/Shell/lxdapi_cloud_install.sh)
```

指定安装包直链：

```bash
LXDAPI_RELEASE_URL=https://example.com/lxdapi-linux-amd64.tar.gz bash <(curl -Ls https://raw.githubusercontent.com/xkatld/lxdapi-web-server/main-stable/Shell/lxdapi_cloud_install.sh)
```
